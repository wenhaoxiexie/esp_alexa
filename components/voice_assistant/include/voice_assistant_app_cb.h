...
typedef enum {
    ...
    VA_THINKING = 1 << 0,    //0000 0001  1
    /** Voice Assistant is Speaking */
    VA_SPEAKING = 1 << 1,   //0000 0010 2
    /** Voice Assistant is Listening */
    VA_LISTENING = 1 << 2,  //0000 0100 4
    /** Voice Assistant is Idle */
    VA_IDLE = 1 << 3,      //0000 1000  8
    /** End of current states markers */
    VA_END_STATES = 1 << 4, //0001 0000  16
    /** Voice Assistant diaglog state Max*/
    VA_DIALOG_STATES_MAX,  //0001 0001  17
} va_dialog_states_t;
...
typedef enum {
    /** Mute is disabled */
    VA_MUTE_DISABLE = (VA_DIALOG_STATES_MAX + 1),    //0001 0010  18
    /** Mute is enabled */
    VA_MUTE_ENABLE,         //0001 0011  19
} va_mute_state_t;
...
typedef enum {
    ...
    VA_SPEAKER_MUTE_ENABLE = (VA_MUTE_ENABLE + 1),    //0001 0100  20
    /** Speaker Mute is enabled */
    VA_SPEAKER_MUTE_DISABLE,                         //0001 0101  21
...
typedef enum {
    /** Set volume  */
    VA_SET_VOLUME = (VA_SPEAKER_MUTE_DISABLE + 1),    //0001 0110 22  
    VA_SET_VOLUME_DONE,                               //0001 0111  23
} va_set_volume_t;
